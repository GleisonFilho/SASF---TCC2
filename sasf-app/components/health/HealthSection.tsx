...
export function HealthSection<T>({
  title, icon, data, isLoading, renderItem, onAdd, onDelete, getId, getLabel, addLabel, emptyIcon = 'file-tray-outline', emptyText = 'Nenhum registro.', readOnly = false,
      ...
      {isLoading ? (
        ...
        data.map((item) => (
          <TouchableOpacity
            ...
            onLongPress={readOnly ? undefined : () => handleDelete(item)}
