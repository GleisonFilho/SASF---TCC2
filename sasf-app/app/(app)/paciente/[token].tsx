  ...
  return (
    <ScreenContainer>
      ...
      <View className="bg-primary-50 rounded-2xl p-4 mb-6 flex-row items-start">
        <Icon name="shield-checkmark-outline" size={16} color="#2563EB" />
        <View className="flex-1 ml-2.5">
          <Text className="text-xs text-primary font-semibold">
            Acesso concedido por {concedidoPor.nome} · Expira em {fmtDate(dataExpiracao)}
          </Text>
          <Text className="text-xs text-primary/70 mt-1">
            Você está vendo apenas as categorias liberadas por este compartilhamento. Todo acesso é registrado para fins de auditoria (LGPD).
          </Text>
        </View>
      </View>
